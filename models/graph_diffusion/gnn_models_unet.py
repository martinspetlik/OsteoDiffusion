...
#         #return h_X
#
# class GNNLayerGCNConv(nn.Module):
#     def __init__(self,
#                  in_channels,
#                  out_channels,
#                  hidden_t):
...
#         #print('hidden_X: {}, hidden_t: {}'.format(hidden_X, hidden_t))
#
#         self.gcnconv = GCNConv(in_channels=in_channels, out_channels=out_channels)
#
#         #self.edge_indices = edge_indices
#
#         self.update_X = nn.Sequential(
...
#         )
#
#     def forward(self, A, data, h_t, batch_size):
#         """
#         Parameters
#         ----------
#         A : dglsp.SparseMatrix
...
#         edge_index = data.edge_index
#
#         h_aggr_X = self.gcnconv(h_X, edge_index)
#
#         #h_aggr_X = h_aggr_X.view(batch_size, int(h_aggr_X.shape[0]/batch_size), h_aggr_X.shape[-1])
#
#         #print("h_aggr_X ", h_aggr_X.shape)
#
#         #h_aggr_X = dglsp.bspmm(A, h_X)  # A @ h_X for batch
...
class GNNTower(nn.Module):
    ...
    def __init__(self,
        ...
        print("gnn layers config ", gnn_layers_config)
        layer_config = gnn_layers_config[0]
        ...
        gnn_layer = GraphUNet(in_channels=layer_config["in_channels"],
                              ...
                              #sum_res=False,
                              depth=layer_config["depth"], hidden_t_embd=hidden_t_embd)

        # gnn_layer = GraphUNet(in_channels=layer_config["in_channels"],
        #                       hidden_channels=layer_config["hidden_channels"],
        #                       out_channels=layer_config["out_channels"], depth=layer_config["depth"])
        #                       #hidden_t_embd=hidden_t_embd)
        ...
        # print("hidden cat gnn: {}, hidden t embd: {}".format(hidden_cat_gnn, hidden_t_embd))
    ...
    def forward(self, data, t):
        ...
        for gnn in self.gnn_layers:
            ...
            h_X = gnn(h_X.x.float(), h_t, h_X.edge_index, batch=data.batch)
