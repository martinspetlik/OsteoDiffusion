...
from models.cnn_diffusion.aldm.normalization import SPADEResnetBlock, SPADEGenerator
from models.cnn_diffusion.aldm.modelss import Encoder, Decoder
...
class ALDMVQGAN(pl.LightningModule):
    ...
    def validation_step(self, batch, batch_idx):
        ...
        #print("log dict ae ", log_dict_ae)
        #del log_dict_ae["val/rec_loss"]
        #print("rec loss ", rec_loss)
        self.log("val/recon_loss", rec_loss,
