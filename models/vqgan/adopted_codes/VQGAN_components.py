...
class Encoder(nn.Module):
    def __init__(self, *, ch, out_ch, ch_mult=(1,2,4,8), num_res_blocks,
        ...
        print("z channels ", z_channels)
        print("attention_resolutions ", attn_resolutions)
        ...
        #self.attention_level_id = []
        for i_level in range(self.num_resolutions):
            print("curr res ", curr_res)
            block = nn.ModuleList()
            attn = nn.ModuleList()
            ...
            for i_block in range(self.num_res_blocks):
                ...
                #     self.attention_level_id.append(i_level)
            down = nn.Module()
            down.block = block
            # down.attn = attn
    ...
    def forward(self, x):
        ...
        for i_level in range(self.num_resolutions):
            for i_block in range(self.num_res_blocks):
                ...
                # if i_level in self.attention_level_id:
